---
title: "Compresión de imágenes usando Análisis de Componentes Principales"
...
En este ejercicio se propone aplicar PCA para comprimir imágenes.
...
```{r, echo=T}
faces_flat <- t(array(faces[,,,1:500], dim=c(128^2*3, 500)))
